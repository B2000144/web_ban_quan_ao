    ...
    <div class="listing-items">
        ...
        <ul>
            ...
            <li>
                ...
                <div class="listing-prop listing-button">
                    <a href="./<?= $config_name ?>_delete.php?id=<?= $row['id'] ?>"><i
                            class="fa-solid fa-circle-minus text-danger"></i></a>
                </div>
                <div class="listing-prop listing-button">
                    <a href="./<?= $config_name ?>_editing.php?id=<?= $row['id'] ?>"><i
                            class="fa-solid fa-pen-to-square text-success"></i></a>
                </div>
                <div class="listing-prop listing-button">
                    <a href="./<?= $config_name ?>_editing.php?id=<?= $row['id'] ?>&task=copy"><i
