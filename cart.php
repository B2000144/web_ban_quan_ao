...
<div class="container">
    <?php if (!empty($error)) { ?>
    <div id="notify-msg">
        <?= $error ?>. <a href="javascript:history.back()">Quay lại giỏ hàng</a>
    </div>
    ...
    <form id="cart-form" action="cart.php?action=submit" method="POST">
        <table>
            ...
            <tr>
                ...
                <td class="product-quantity"><input min="1" max="100" type="number"
                        value="<?= $_SESSION["cart"][$row['id']] ?>" name="quantity[<?= $row['id'] ?>]" /></td>
